...
### Увод
Този дипломна работа има за цел да пресъздаде не безизвестната игра Pong във формата на мултиплейър игра (за двама), която се играе на поле, съставено от матрица от светлинни диоди.
